	...
	methods(Static = true)
		...
		function [Dist, Maps] = UBC_Nima_Fitting(SimulatedData, MyInfo)
			...
			if MyInfo.TrueFAFlag
				[Maps, Dist, ~] = T2map_Nima(temp, 'FlipAngleMap', MyInfo.FlipAngle*ones(1,1,size(SimulatedData,1)), 'T1', MyInfo.T1,'Threshold', 0,'nT2', nT2,'T2Range', [0.008, 2], 'MinRefAngle', 100,...
