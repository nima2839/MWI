...
%LFGC_Fitted = NNLS_T_Batch_Fitting(Mag,E,Opt,
    X0 = [0.05 9e-3 0 0.9 6e-2 20 0.05 0.5 10];
    lb = [0 0.1e-3 -40 0.1 20e-3 -50 0 8e-2 -50];
    ub = [1 120e-3 40 1 155e-3  50 1 5 50];
...
disp('Saving results...')
Description = 'Calculating MWF from LFG corrected data!';
clear Mag Phase
save('NM_Test1_3PM_BoB_65E')
disp('Done!')
